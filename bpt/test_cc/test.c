...
void* SST_func(void* args) {
  ...
  for (;;) {
    ...
    printf("Thread operation_count = %ld\n", operation_count);
...
void single_thread_test() {
  ...
  printf("Database initialized. Starting single thread test...\n");
  ...
  printf("\n==============================================\n");
  printf("[PASS] Single thread test completed successfully!\n");
  printf("==============================================\n\n");
...
void slock_test() {
  ...
  printf("Database initialized. Starting s-lock test with %d threads...\n",
         SLT_THREAD_NUMBER);
  ...
  printf("\n==============================================\n");
  printf("[PASS] S-lock test completed successfully!\n");
  printf("==============================================\n\n");
...
void xlock_test() {
  ...
  printf("Database initialized. Starting x-lock test with %d threads...\n",
         XLT_THREAD_NUMBER);
  ...
  for (;;) {
    ...
    printf("Progress: %ld / %d operations...\n", operation_count_0,
           XLT_OPERATION_NUMBER);
    ...
    if (operation_count_0 == operation_count_1) {
      printf(
          "\n[FAIL] INCORRECT: all threads are stuck (Deadlock suspected).\n");
    }
  }
  ...
  printf("\n==============================================\n");
  printf("[PASS] X-lock test completed successfully!\n");
  printf("==============================================\n\n");
...
void mlock_test() {
  ...
  printf("Database initialized. Starting mixed lock test with %d threads...\n",
         MLT_THREAD_NUMBER);
  ...
  printf("\n==============================================\n");
  printf("[PASS] M-lock test completed successfully!\n");
  printf("==============================================\n\n");
...
void deadlock_test() {
  ...
  printf("Database initialized. Starting deadlock test with %d threads...\n",
         DLT_THREAD_NUMBER);
  ...
  printf("\n==============================================\n");
  printf("[PASS] Deadlock test completed successfully!\n");
  printf("==============================================\n\n");
